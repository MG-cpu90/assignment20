  ...
  state = {
    assignments:  [
      ...
      },
      {
        ...
        "description": "A MERN application built using react, that allows users to search for books through google, add them to or fremove them from a reading list, and view information about them.",
        "technologies": [
          "HTML",
          "CSS",
          "Bootstrap",
