    ...
    assignments: [
      {
        ...
        description:
          "A website built using JavaScript that allows users to generate a random secure password based on a number of selected criteria.",
      ...
      },
      {
        ...
        description:
          "An online quiz made using JavaScript and jQuery that allows users to test their basic general knowledge of coding.",
        technologies: [
          "HTML",
          "CSS",
      ...
      },
      {
        ...
        description:
          "A CLI application that prompts users to respond to some questions and subsequently generates a ReadMe file from a template which includes the information acquired from the users' responses.",
        technologies: [
          "APIs",
          "JavaScript",
          "jQuery",
      ...
      },
      {
        ...
        description:
          "A CLI application that allows managers to generate a team html page by prompting them for a series of questions on professional information about themselves and their employees through node.",
        technologies: [
          "HTML",
          "CSS",
          "BootStrap",
      ...
      },
      {
        ...
        description:
          "A full-stack web application that allows users to create and save notes to a json file, or delete them.",
        technologies: [
          "HTML",
          "CSS",
          "BootStrap",
      ...
      },
      {
        ...
        description:
          "A CLI application that allows users to organise their business by viewing, adding, or updating departemnts, roles, and employees in a company.",
        technologies: [
          "APIs",
          "JavaScript",
          "jQuery",
      ...
      },
      {
        ...
        description:
          'A restaurant application using node, express, and handlebars, that allows users to add burgers to the menu using a form, and subsequently to "devour" them using a button, which adds them to the "Devoured Burgers" list.',
        technologies: [
          "HTML",
          "CSS",
          "Bootstrap",
      ...
      },
      {
        ...
        description:
          "A front-end application built using react, that allows users to sort columns of a table of employees, and to filter employees by their name.",
        technologies: [
          "HTML",
          "CSS",
          "Bootstrap",
